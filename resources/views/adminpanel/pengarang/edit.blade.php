        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ Form::model($pengarangs, ['route'=>['pengarang.update', $pengarangs->id], 'method'=>'PATCH']) }}
                        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            {{ Form::label('nama', 'Nama pengarang') }}
                            {{ Form::text('nama', null, ['class'=>'form-control', 'placeholder'=>'Masukkan Nama Pengarang']) }}
